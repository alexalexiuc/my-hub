...
with basic CRUD operations across all domain tables (meals, profiles, measurements, trips,
inventory, etc.). Later iterations will add domain-specific visualisations such as
calorie charts.
...
| ID    | Requirement                                                                                                                                                                 |
| ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FR-01 | The admin must be able to browse any domain table (meals, profiles, body measurements, trips, product inventory, shopping list, product catalog) in a paginated table view. |
...
| ID    | Requirement                                                                                           |
| ----- | ----------------------------------------------------------------------------------------------------- |
| FR-06 | _Removed_ — the apiary timeline view was dropped together with the Apiary feature.                    |
...
- [ ] An admin can create a new body measurement record via the form.
