...
| ID    | Requirement                                                                                                                                                        |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| FR-01 | The admin must be able to see a list of all registered MCP sub-servers (e.g. Calories, Travel, Finances, Products) and their current enabled/disabled state.       |
...
- [x] Inactive servers (Products) are shown with reduced opacity, disabled toggles, and "Coming soon" labels.
