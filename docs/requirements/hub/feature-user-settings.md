...
- [x] The "Delete all my data" action clears all user-linked records across supported features (including OAuth/MCP, notifications, travel, finances, and request logs).
