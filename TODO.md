...
- [ ] Organize logging to be in a single place, not scattered around. log function in route.ts should receive error object as is, and then internally decide what to do with i
