  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {rowsMissingDate.length > 0 && (
        <div className="rounded-[8px] border border-[var(--red)] bg-[var(--card2)] px-3 py-2 text-xs text-[var(--red)]">
      ...
      {duplicateRows.length > 0 && (
        <div className="rounded-[8px] border border-[var(--amber)] bg-[var(--card2)] px-3 py-2 text-xs text-[var(--amber)]">
