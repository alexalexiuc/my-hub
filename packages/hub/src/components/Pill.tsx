...
export function Pill({ icon, label, color, className, onClick, onRemove, disabled = false, title }: PillProps) {
  const pillClassName = cn(
    'inline-flex items-center gap-1 rounded-[20px] border px-2 py-[2px] text-[11px] font-medium transition-[filter,transform] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]',
