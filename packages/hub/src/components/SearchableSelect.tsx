...
// Re-export so consumers can import option types from this file.
export type { DropdownOption, SelectCreateOption } from './searchableSelect.utils';
export { buildDropdownFuse, applyDropdownFilter } from './searchableSelect.utils';
...
type SearchableSelectSearchableProps = SearchableSelectBaseProps & {
  searchable?: true;
...
type SearchableSelectNonSearchableProps = SearchableSelectBaseProps & {
...
export type SearchableSelectProps = SearchableSelectSearchableProps | SearchableSelectNonSearchableProps;
